  ...
  dynamic "lifecycle_rule" {
    ...
    content {
      ...
      condition {
        ...
        matches_prefix             = lookup(lifecycle_rule.value.condition, "matches_storage_prefix", null)
        matches_suffix             = lookup(lifecycle_rule.value.condition, "matches_storage_suffix", null)
