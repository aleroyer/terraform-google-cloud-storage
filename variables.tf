...
variable "lifecycle_rules" {
  type = set(object({
    ...
    # - matches_prefix - (Optional) Comma delimited string of one or more matching name prefixes to satisfy this condition.
    # - matches_suffix - (Optional) Comma delimited string of one or more matching name suffixes to satisfy this condition.
